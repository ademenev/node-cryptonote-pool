...
Rename this file to default.js, then overview the options 
and change any to match your preferred setup.

You can have separate configs for development and production
environments, see https://github.com/lorenwest/node-config
for details.
...
module.exports = {
    ...
    poolServer: {
        ...
        slushMining: {
            ...
            // The value should roughly be equivalent to the average round duration in seconds divided by 8.
            // When deviating by too much numbers may get too high for JS.
            weight: 300, 
            blockTime: 60,
        
            //How often the pool checks the timestamp of the last block.
            // Lower numbers increase load but raise precision of the share value
