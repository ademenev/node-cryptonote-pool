<template>
  <main-layout>
    ...
    <div class="stats">
        <div><i class="fa fa-cloud"></i> Mining Pool Address: <span id="miningPoolHost">{{poolHost}}</span></div>
    </div>


    <h4>Mining Ports</h4>
    <div class="row" id="miningPorts" v-if="stats.config">
        <div class="stats" v-for="portData in stats.config.ports" :key="portData.port">
            <div><i class="fa fa-tachometer"></i> Port: <span class="miningPort">{{ portData.port }}</span></div>
            <div><i class="fa fa-unlock-alt"></i> Starting Difficulty: <span class="miningPortDiff">{{ portData.diff }}</span></div>
            <div><i class="fa fa-question"></i> Description: <span class="miningPortDesc">{{ portData.desc }}</span></div>
        </div>
    </div>
    ...
    <h3>Mining Apps</h3>
    <div class="yourStats table-responsive"  v-if="stats.config">
        <table class="table">
            <thead>
            <tr>
            ...
            <tr>
                <td colspan="5">
                    <span>Example:</span>
                    <code>minerd -a cryptonight -o stratum+tcp://<span class="exampleHost">{{poolHost}}</span>:<span class="examplePort">{{stats.config.ports[0].port}}</span> -u <span class="exampleAddress">YOUR_WALLET_ADDRESS</span> -p x</code>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td colspan="5">
                    <span>Example:</span>
                    <code>yam -c x -M stratum+tcp://<span class="exampleAddress">YOUR_WALLET_ADDRESS</span>:x@<span class="exampleHost">{{poolHost}}</span>:<span class="examplePort">{{stats.config.ports[0].port}}</span>/xmr</code>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td colspan="5">
                    <span>Example:</span>
                    <code>NsCpuCNMiner64 -o stratum+tcp://<span class="exampleHost">{{poolHost}}</span>:<span class="examplePort">{{stats.config.ports[0].port}}</span> -u <span class="exampleAddress">YOUR_WALLET_ADDRESS</span> -p x</code>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td colspan="5">
                    <span>Example:</span>
                    <code>NsGpuCNMiner -o stratum+tcp://<span class="exampleHost">{{poolHost}}</span>:<span class="examplePort">{{stats.config.ports[0].port}}</span> -u <span class="exampleAddress">YOUR_WALLET_ADDRESS</span> -p x</code>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td colspan="5">
                    <span>Example:</span>
                    <code>ccminer -o stratum+tcp://<span class="exampleHost">{{poolHost}}</span>:<span class="examplePort">{{stats.config.ports[0].port}}</span> -u <span class="exampleAddress">YOUR_WALLET_ADDRESS</span> -p x</code>
                </td>
            </tr>
            </tbody>
        </table>
