...
class Logger {
    ...
    constructor(system, prefix) {
        this.system = system;
        this.prefix = prefix || "";
    }
    debug (text, data) {
        log(DEBUG, this.system, this.prefix + text, data);
    }
    info (text, data) {
        log(INFO, this.system, this.prefix + text, data);
    }
    warn (text, data) {
        log(WARN, this.system, this.prefix + text, data);
    }
    error (text, data) {
        log(ERROR, this.system, this.prefix + text, data);
    }
}
